    ...
    void add_new_news(MouseEvent event) throws SQLException {
        ...
        if (titleTest == 1 && descriptionTest == 1 && shortDescTest == 1 && photoTest == 1) {
            ...
            try {
                ...
                // FXMLLoader loader = new FXMLLoader(getClass().getResource("C:/Users/daoid/Desktop/1Esprit/PIDEV/LeagueOfBoostDesktop/LeagueOfBoost/src/LeagueOfBoost/gui/NewsInterfaces/AdminNewsList.fxml"));
