...
public class AdminNewsListController implements Initializable {
  ...
  private void open_addNews(MouseEvent event) throws IOException {
    News.actionTest = 0;
    Parent fxml = FXMLLoader.load(getClass().getResource("/NewsInterfaces/AdminAddNews.fxml"));
  ...
  private void setNewsGridPaneList() {
    ...
    try {
      for (int i = 0; i < newsList.size(); i++) {
        ...
        fxmlLoader.setLocation(getClass().getResource("/NewsInterfaces/AdminNewsCard.fxml"));
