...
public class UserDashboardController implements Initializable {
    ...
    void open_actualiteList(MouseEvent event) throws IOException {
        Parent fxml = FXMLLoader.load(getClass().getResource("../NewsInterfaces/UserNewsList.fxml"));
    ...
    void open_favList(MouseEvent event) throws IOException {
        Parent fxml = FXMLLoader.load(getClass().getResource("../NewsInterfaces/UserNewsFavoris.fxml"));
        content_area.getChildren().removeAll();
        content_area.getChildren().setAll(fxml);
